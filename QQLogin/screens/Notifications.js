        ...
        <View style={styles.container}>
                <View style={styles.header}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                        <TouchableOpacity style={{ marginRight: 15, width: 50, paddingTop: 70 }}
            ...
            <View style={styles.body}>
                <View style={styles.bodyContent}>
                    ...
                    <Text style={{ marginLeft: 10, paddingBottom: 10, fontSize: 13 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fringilla quam eu faci lisis mollis.</Text>
                    <TouchableOpacity style={styles.buttonContainer}>
                        <MaterialCommunityIcons name="bell-ring" size={20} color="#FFCC15" />
