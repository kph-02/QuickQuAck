            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    <View style={{ flexDirection: 'row', marginLeft: 0, justifyContent: 'space-evenly' }}>
                        <TouchableOpacity style={{ marginRight: 70, width: 50, paddingTop: 70 }}
                            onPress={() => navigation.navigate('Feed')}>
                            <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF' }}>Back</Text>
                        </TouchableOpacity>
                            <Text style={styles.headline}>Profile</Text>
                        <TouchableOpacity style={{ marginLeft: 60, width: 60, paddingTop: 70 }}
                                onPress={() => navigation.navigate('Login')}>
                            <Text style={{ fontSize: 18, fontWeight: '600', color: '#FFFFFF' }}>Logout</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <Image style={styles.avatar} source={{ uri: 'https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2013/8/1/1375354802439/Blue---the-colour-008.jpg?width=300&quality=45&auto=format&fit=max&dpr=2&s=d32b70ddf7ecff3771c2d99d32eae422' }} />
